...
import {framecraftAt} from './launch.mjs';
...
const child = spawn(process.execPath, [path.join(root, 'scripts/install/launch.mjs'), '--no-open'], {cwd: root, stdio: 'inherit', env: {...process.env,
