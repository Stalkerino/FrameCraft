...
- **Audio effects:** audio clips participate in coordinated cuts and moves. Imported music and sound effects, mixing, static volume and mute are supported; volume automation, fades/crossfades, ducking, EQ and other editable audio effects remain separate missing capabilities.
