...
export function NumberField({label, value, onCommit, min = 0, max = 999999, step = 1, suffix, disabled = false}: {label: string; value: number; onCommit: (value: number) => void; min?: number; max?: number; step?: number; suffix?: string; disabled?: boolean}) {
