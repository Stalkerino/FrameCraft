import {Check, Download, FilePlus2, FolderOpen, LoaderCircle, Settings2} from 'lucide-react';
...
export function Header() {
  ...
  useEffect(() => {setProjectDialog(null); setSettingsDialog(false); setExportDialog(false); setClearDialog(false); setEditing(false);}, [snapshot?.project.id]);
