...
export function CodexPanel() {
  ...
  const content = <>
    ...
    <div className="agent-panel-content" role="tabpanel" aria-label={`${providerName} ${tab}`}>{tab === 'chat' ? <AgentConversation/> : tab === 'activity' ? <AgentActivityPanel/> : <AgentConnectionPanel status={status} error={error}/>}</div>
  </>;
