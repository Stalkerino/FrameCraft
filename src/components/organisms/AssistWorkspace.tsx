import {Clapperboard, Focus, MessageSquareText, Search, Scissors} from 'lucide-react';
...
export function AssistWorkspace() {
  ...
  const tabs = [{id: 'gameplay', label: 'Automatic Cuts', icon: Scissors}, {id: 'speech', label: 'Transcript & captions', icon: MessageSquareText}, {id: 'search', label: 'Search footage', icon: Search}, {id: 'cut', label: 'Rough cut', icon: Clapperboard}, {id: 'overlays', label: 'Zooms & callouts', icon: Focus}] as const;
